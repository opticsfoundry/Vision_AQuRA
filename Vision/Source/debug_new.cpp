...
#define _DEBUG_NEW_HASHTABLESIZE 65536
#endif
 ...
 */
const char* new_progname = "E:\FeLiKx\VisionFeLiKx\exe\vision.exe";
...
void* operator new(size_t size) throw(xalloc)
{
